...
const sections = [
  {
    ...
    body: 'האפליקציה שומרת את נתוני שעות העבודה, ההפסקות, ושיעור השכר שלך. הנתונים מאוחסנים במכשיר שלך ובשרת מאובטח, ומקושרים לזיהוי מכשיר אנונימי.',
  },
  {
  ...
  {
    title: 'מחיקת נתונים',
    body: 'ניתן למחוק את כל הנתונים בכל עת מהגדרות האפליקציה, או על ידי הסרת האפליקציה מהמכשיר.',
  },
  {
    title: 'יצירת קשר',
    body: 'לשאלות בנושא פרטיות, ניתן לפנות אלינו דרך חנות האפליקציות.',
  },
];
