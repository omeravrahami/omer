...
const sections = [
  ...
  {
    title: 'אחסון ואבטחה',
    body: 'הנתונים מוצפנים בעת העברה (HTTPS). נתוני ההגדרות נשמרים גם מקומית במכשיר באמצעות AsyncStorage.',
  },
  {
    title: 'פרסומות',
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: BG_DEEP }} testID="privacy-screen">
      ...
      >
        ...
        >
          ...
          >
            {'clocker מחויבת להגנה על פרטיותך. מסמך זה מסביר אילו נתונים אנחנו אוספים, כיצד אנחנו משתמשים בהם, ואיך אנחנו שומרים עליהם.'}
          </Text>
        </View>
