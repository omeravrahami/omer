...
// ---------------------------------------------------------------------------
// Settings (LEGACY — device-based, kept for backward compatibility)
// ---------------------------------------------------------------------------

// GET /api/settings/:deviceId — get or create default settings
// REMOVED: legacy deviceId-based settings route

// PUT /api/settings/:deviceId — update settings
// REMOVED: legacy deviceId-based settings route

// ---------------------------------------------------------------------------
// Work Sessions (LEGACY — device-based, kept for backward compatibility)
// ---------------------------------------------------------------------------

// REMOVED: all legacy deviceId-based session routes (/api/sessions/:deviceId/*)

// ---------------------------------------------------------------------------
// Breaks (LEGACY — device-based, kept for backward compatibility)
// ---------------------------------------------------------------------------

// REMOVED: all legacy deviceId-based break routes

// ---------------------------------------------------------------------------
// Stats (LEGACY — device-based, kept for backward compatibility)
// ---------------------------------------------------------------------------

// REMOVED: legacy deviceId-based stats route (/api/stats/:deviceId)
